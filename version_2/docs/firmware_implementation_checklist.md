...
contract, firmware interface contract, or architecture. Complete the four gates independently:

- **Implemented:** the intended code and documentation exist.
- **Static:** review, host test, parser test, or firmware build passes as applicable.
- **Bench:** the behavior is verified on assembled Rev-1 hardware. Use N/A only when hardware
  cannot affect the result.
- **Complete:** the item meets its acceptance condition with evidence and has no blocking open issue.

Record test logs, captures, and measurements in the final Evidence column. A successful build alone
does not count as bench verification.

## 0. Hardware and contract gates

| ID | Deliverable and acceptance condition | Implemented | Static | Bench | Complete | Evidence |
|---|---|:---:|:---:|:---:|:---:|---|
...
| FW-13 | Test bit order, latch behavior, unrelated-bit preservation, and invalid arguments with fake GPIO callbacks | [ ] | [ ] | N/A | [ ] | |
...
| ID | Deliverable and acceptance condition | Implemented | Static | Bench | Complete | Evidence |
|---|---|:---:|:---:|:---:|:---:|---|
| FW-19 | Define private AD7779 registers, fields, commands, and supported limits from the datasheet | [ ] | [ ] | N/A | [ ] | |
...
| FW-25 | Run driver tests with fake SPI for transactions, timeouts, corrupt frames, and configuration readback | [ ] | [ ] | N/A | [ ] | |
...
| ID | Deliverable and acceptance condition | Implemented | Static | Bench | Complete | Evidence |
|---|---|:---:|:---:|:---:|:---:|---|
| FW-32 | Define ADC frame, block, status, flags, pulse request/result, and counter types from the interface contract | [ ] | [ ] | N/A | [ ] | |
...
| ID | Deliverable and acceptance condition | Implemented | Static | Bench | Complete | Evidence |
|---|---|:---:|:---:|:---:|:---:|---|
| FW-40 | Freeze frame fields, message identifiers, stable error codes, and payload layouts in `shared/protocol` | [ ] | [ ] | N/A | [ ] | |
| FW-41 | Implement little-endian framing, 2048-byte payload limit, explicit serialization, and CRC-32C | [ ] | [ ] | N/A | [ ] | |
| FW-42 | Implement incremental parsing and recovery from partial, concatenated, corrupt, and unknown frames | [ ] | [ ] | N/A | [ ] | |
| FW-43 | Pack each selected ADC code into exactly three little-endian two's-complement bytes | [ ] | [ ] | N/A | [ ] | |
| FW-44 | Implement the required Milestone-1 handshake, configuration, acquisition, status, pulse, and error messages | [ ] | [ ] | [ ] | [ ] | |
| FW-45 | Add shared valid/invalid golden vectors consumed independently by firmware and host tests | [ ] | [ ] | N/A | [ ] | |
...
| FW-67 | Update `README.md`, `ARCHITECTURE.md` implementation status, and affected contracts to match verified behavior | [ ] | [ ] | N/A | [ ] | |
